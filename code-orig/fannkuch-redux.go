...
// New Variables for Benchmarking
var (
    startTime time.Time
...
// Function to end benchmarking and print results
func endBenchmark() {
    endTime := time.Now()
    ...
    fmt.Printf("Peak Memory: %v KB\n", (endMem.TotalAlloc - startMem.TotalAlloc) / 1024)
...
func main() {
    ...
    // End Benchmarking and Print Results
    endBenchmark()
}
